...
public class Runner extends Logging {
    ...
    public static void main(String[] args) throws Exception {
        if(args.length < 1) {
            System.out.println("Please provide test name: e.g. Test2");
            System.exit(1);
        }
        // Set this for now
        ...
        String classfile = "/Users/amytis/Projects/Test-Minimization-in-Big-Data/udf_extractor/target/scala-2.11/classes/"+args[0]+"$";
        String conf_file = "/Users/amytis/Projects/Test-Minimization-in-Big-Data/udf_extractor/src/main/scala/"+args[0]+".conf";
